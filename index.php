        ...
        <div class="container">
            ...
            <form method="post" enctype="multipart/form-data">
                ...
                <input
                    ...
                    name="shopName"
                    id="shopName"
                    placeholder="Where did you buy this product from?"
                />
                <input
                    type="number"
                    name="price"
                ...
                <input
                    ...
                    name="billNumber"
                    id="billNumber"
                    placeholder="What's the bill number"
                />
                <input
                    type="date"
                    name="dateOfPurchase"
                    id="dateOfPurchase"
                    placeholder="When did you buy the product?"
                />
                <input
                    type="number"
                    id="shopNumber"
                    name="shopNumber"
                    placeholder="What's shopkeepers number?"
                />
                <input
                    type="number"
                    id="quantity"
                    name="quantity"
                    placeholder="How many products did you buy?"
                />
                <input
                    type="text"
                    id="validity"
                    name="validity"
                    placeholder="Validity or warranty of the product?"
                />
                <input
                    name="somethingElse"
                    id="somethingElse"
                    rows="10"
                    placeholder="Something else about the product"
                />
